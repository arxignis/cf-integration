/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler-dev.jsonc` (hash: b3e84d5e0356f8903feb640503095106)
// Runtime types generated with workerd@1.20250803.0 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AX_CACHE: KVNamespace;
		ARXIGNIS_API_URL: "http://localhost:9999/v1";
		BUFFER_FLUSH_INTERVAL: "5000";
		BUFFER_MAX_RETRIES: "3";
		MODE: "block";
		PERFORMANCE_METRICS: "true";
		PROMETHEUS_URL: "https://api.axiom.co/v1/traces";
		PROMETHEUS_HEADERS: {"Authorization":"Bearer xaat-baf51559-3896-4f2e-b77b-b6f1e5b9f63a","X-Axiom-Dataset":"dev"};
		TURNSTILE_SITE_KEY: string;
		TURNSTILE_SECRET_KEY: string;
		ARXIGNIS_API_KEY: string;
		LOG_BUFFER: DurableObjectNamespace<import("./src/index").LogBufferDO>;
		METRICS_BUFFER: DurableObjectNamespace<import("./src/index").MetricsBufferDO>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ARXIGNIS_API_URL" | "BUFFER_FLUSH_INTERVAL" | "BUFFER_MAX_RETRIES" | "MODE" | "PERFORMANCE_METRICS" | "PROMETHEUS_URL" | "PROMETHEUS_HEADERS" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "ARXIGNIS_API_KEY">> {}
}

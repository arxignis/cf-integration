...
if [ "$turnstile_keys_provided" = true ]; then
    ...
    turnstile_response=$(curl -s -X POST "https://api.cloudflare.com/client/v4/accounts/$cf_account_id/challenges/widgets" \
        ...
        -d "{
              ...
              \"mode\": \"managed\",
              \"name\": \"Arxignis Proxy Protection\",
